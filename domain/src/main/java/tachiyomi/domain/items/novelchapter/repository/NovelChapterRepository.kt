...
interface NovelChapterRepository {
    ...
    suspend fun getChapterByNovelId(novelId: Long, applyScanlatorFilter: Boolean): List<NovelChapter>
    ...
    suspend fun getChapterByNovelIdAsFlow(novelId: Long, applyScanlatorFilter: Boolean): Flow<List<NovelChapter>>
